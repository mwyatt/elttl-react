      ...
      <table className='table-auto w-full mt-4'>
        <thead>
          <tr>
            ...
            <th className='p-1 sm:p-2 md:p-4 hidden sm:block'>Team</th>
            <th className='p-1 sm:p-2 md:p-4'>R<span className='hidden sm:inline'>a</span>nk</th>
            ...
            <th className='p-1 sm:p-2 md:p-4'>Av<span className='hidden sm:inline'>era</span>g<span className='hidden sm:inline'>e</span></th>
            <th className='p-1 sm:p-2 md:p-4'>Enc<span className='hidden sm:inline'>ounters</span></th>
          </tr>
        </thead>
        <tbody>
          ...
          {stats.map((stat, index) => (
            <tr key={index} className='border-t border-dashed hover:bg-gray-100'>
              ...
              <td className='p-1 sm:p-2 md:p-4 text-center'>{Math.floor(stat.average * 100)}</td>
              <td className='p-1 sm:p-2 md:p-4 text-center'>{stat.encounter}</td>
            </tr>
          ))}
