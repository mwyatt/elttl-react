...
<h3 id="name-and-governance">NAME AND GOVERNANCE</h3>
<ol>
<li>The League shall be called the EAST LANCASHIRE TABLE TENNIS LEAGUE (“the League”)</li>
</ol>
<p>1a. The affairs of the League shall be governed by a General Committee (“the Committee”)
constituted as provided below.</p>
<p>Objects:</p>
<ol>
<li>The League shall be open to participation by clubs, teams and individuals in the East Lancashire
district subject to the approval of the Committee.</li>
</ol>
<p>2a. The League shall be non- profit making and any surplus shall be ploughed back into the League
and shall not be for the financial gain of any individual.</p>
<p>2b. The principal purposes and functions of the League shall be to promote and support table tennis
within the East Lancashire area, in particular by:</p>
<ul>
...
<li>Providing a central base for the League (currently at Hyndburn Sports Centre) with practice
  ...
  subject to the approval of the Committee</li>
<li>Providing or arranging coaching and training facilities</li>
</ul>
<p>Affiliation and Registration</p>
<ol>
<li>The League shall be affiliated to the English Table Tennis Association (“Table Tennis England” /
“TTE”) and the Lancashire County Table Tennis Association (“LCTTA”) and shall comply with their
rules and regulations.</li>
</ol>
<p>3 a. Only TTE registered Compete and Compete Plus Members may play in the leagues, competitions
and similar events run by the League,</p>
<p>Membership</p>
<ol>
...
</code></pre><p>4a. All applications for playing membership of the League shall be made in accordance with the Rules
below only to the Fixtures Secretary, who shall decide upon the application unless overridden by the
Committee.</p>
<p>4b. All Fees shall be paid prior to the commencement (normally in September) of the Annual League
Programme or immediately upon joining during the Programme in accordance with the Rules below
and will include: TTE and LTTA registration, individual membership, team fees, and, for those playing</p>
<p>out of Hyndburn Table Tennis Centre, room and table fees. Fees (other than TTE/ LCTTA registration
fees) shall be fixed for the forthcoming Season at the AGM or, in default, by the Committee and may
be varied by the Committee if necessary to meet unanticipated changes or eventualities.</p>
<p>4c. All clubs, teams and individuals joining the League shall be deemed to accept this Constitution
and Rules on admission.</p>
<p>The General Committee</p>
<ol>
<li>The Committee shall consist of the Officers and other Committee Members elected at the AGM or
...
representative) and must be League Members.</li>
</ol>
<p>5b. All such Officers and Committee Members shall hold office for two Seasons from the AGM at
...
Members they shall automatically retire from office.</p>
<p>5c. The powers and duties of the Committee shall include:</p>
<ul>
...
<li>Keeping accurate accounts of the finances of the League through the Treasurer and producing
  an Annual Account at the AGM</li>
<li>Deciding issues arising in the course of running the leagues, competitions and events
  organised by the League.</li>
<li>Fining, suspending or expelling any player or club as deemed necessary if found guilty of
  misconduct or breach of this Constitution and Rules.</li>
</ul>
<p>5d. The Committee shall meet as and when decided at their last meeting or when called by the
...
automatically retired.</p>
<p>Meetings</p>
<ol>
<li>All meetings of the League and of the Committee shall be chaired by the Chairman or, in his
...
have a deciding vote. Five people entitled to vote shall form a quorum at all meetings.</li>
</ol>
<p>6a. AGM: The Annual General Meeting of the League shall be held during May each year on a date to
...
Members (as defined under 4 above) shall be entitled to attend the AGM and will be eligible to vote.</p>
<p>6b. The AGM Agenda shall include the following:</p>
<ul>
...
<li>Election of Officers and Committee Members when the current holder’s term of office is
  expiring or to fill any vacancies</li>
...
<li>Any matters of which any League Member has given written or email notice to the Secretary at
  least 14 days before the AGM.</li>
</ul>
<p>6c. EGM: An Extraordinary General Meeting (“EGM”) of the League to resolve any significant issues
...
less than 21 days in the same manner as in 6a above for the AGM.</p>
<p>Change of Officers, Constitution or Rules</p>
<ol>
<li>No election of Officers or alteration to this Constitution and Rules may be made except at the AGM
...
at the meeting to support their motion.</li>
</ol>
<p>Dissolution</p>
<ol>
<li>The League may only be dissolved by successful motion at an AGM or EGM. Advance Notice of
...
favour of dissolution.</li>
</ol>
<p>8a. In the event that the League is dissolved or otherwise wound up, any surplus assets (including
...
of such an organisation) and thereafter for the general purposes of TTE.</p>
<h2 id="rules">RULES</h2>
<p>Annual League</p>
<ol>
<li>The annual league competition will normally begin in September and will be a competition for
teams arranged in divisions as provided below. The Fixtures Secretary will maintain and publish a
running record of match points and results, individual points scores and an individual Merit Table.</li>
</ol>
<p>1 0. In the event that a situation arises that is not covered by the Rules, or a rule is unclear, or in other
...
next AGM if considered appropriate.</p>
<p>Teams, Team Secretaries and Registration</p>
<ol>
<li>All players wishing to play in the annual league must be registered in a team of at least three.
Each team must have a designated Team Secretary who shall be the contact point and organiser for
that team but need not play for it. One person may be the Team Secretary for more than one team.</li>
<li>All Team Secretaries must provide a telephone number where they can be contacted and an
...
without confirming they have received it.)</li>
<li>Any change of Team Secretary, Venue, Match night, address or telephone number shall be
notified immediately to the Fixtures Secretary. In addition the opposition Team Secretaries shall be
notified as soon as possible</li>
<li>Teams from all divisions can have a team of up to eight players registered at any one time,
however teams from within the lowest division may have up to 10 players registered at any one time.</li>
<li>Each team shall register sufficient players to enable it to fulfil the entire League season and cup
matches programme.</li>
</ol>
<p>1 6. Fees (per season) &amp; entry to the league: All Team Secretaries shall forward to the Fixtures
...
League”. Where cash is paid, a signed receipt must be obtained.</p>
<p>17.Each division is based normally on having ten teams, each team will play home and away. At the
...
which would be subject to the discretion of the Committee).</p>
<ol>
<li>All players must be registered with both TTE and the League and have paid their membership
...
subject to approval by the Committee to ensure such a player does not unfairly change the nature of</li>
</ol>
<p>the competition. Only in exceptional circumstances will any new registrations be permitted after
...
what standard and division any particular team should then be placed).</p>
<ol>
<li>During the season any transfers to another team are to be made in writing to the League
...
automatically transferred to the higher team as in rule 20 below.</li>
</ol>
<p>19 a. Any player having a handicap of 6 or less must play at least 25% of the remaining league
matches otherwise any points won will be discounted. Playing in a doubles game does not qualify as
a match.</p>
<ol>
<li>Any team can nominate reserves providing they are from a lower division and have a lower
...
rest of the conditions above. (Exception for Juniors – see Rule 20b below)</li>
</ol>
<p>20a. Players can play up for any team as long as they do not exceed more than 5 matches for any
one team and play within the above rules.</p>
<p>20b. Junior players can play up for any team in any division any number of times.</p>
<p>20 c. A team consisting wholly of Junior players may play all their fixtures at their home venue. In the
event that both teams are all Juniors the normal home and away system will apply 21. If a team
resigns from the League, all points will be removed and all monies forfeited.</p>
<ol>
<li>To be included in the final Merit Table a player must play a minimum of 50% +1 of possible league
matches during the season.</li>
</ol>
<p>Matches and Points</p>
<ol>
<li>The current rules of table tennis as adopted by TTE and LCTTA shall apply to all matches in the
League</li>
<li>All matches shall ideally be played on the dates stated on the fixture list. If either team is unable to
...
award points to either side depending on the common sense fairness of either the request to re-</li>
</ol>
<p>arrange, or the refusal to do so. (Note 24a below - no penalty if at least two weeks notice was given)
When awarding points in accordance with this rule; the points for, should be based on an average
over the season; the points against, should be nil.</p>
<p>24a. A match can be postponed without penalty if more than 2 weeks notice is given to the other
team. The opposition Team Secretary must agree to re-arrange the match.</p>
<p>24 b. A match can be postponed without penalty if a team cannot field three players due to a town
team commitment. The opposition Team Secretary must agree to re-arrange the match.</p>
<p>24 c No re-arrangements may be made or requested on the same days as the original fixture date,
save in exceptional circumstances such as inclement weather.</p>
<ol>
<li>Any points won by an unregistered (See Notes on Affiliation and Membership) player(s) will not be
counted nor awarded retrospectively. The opposition will be awarded the points as if that player(s)
had not been present.</li>
<li>All matches shall commence no later than 7:30pm. One player must be in attendance at 7:30, the
...
have the final say on the matter.</li>
<li>The Home team shall enter the playing order of its players on the scorecard first, then the away
...
scorecard for the doubles game.</li>
<li>The match ball must be approved by both teams prior to the commencement of the match. In the
event that an agreement cannot be reached a new ball must be used.</li>
<li>The Home team’s Team Secretary has the sole responsibility to notify the Fixtures Secretary of
...
Committee.</li>
<li>In the event of two or more teams having the same number of points at the end of the season,
...
head statistics over the two games versus each other in the season.</li>
</ol>
<p>Cup and Other Competitions</p>
<ol>
<li>Players from anywhere in the League can be signed on for a team in a cup match, but they can
only play for one team in a season</li>
</ol>
<ol>
<li>No player shall be eligible to take part in the semi-final stages of any individual knock- out
...
different team earlier in that season,</li>
</ol>
<p>Fred Holden Handicap Competition</p>
<p>33 The Fred Holden Competition will be organised during the season. This will be organised on a
team handicap basis. All teams will participate.</p>
<p>33a. Fred Holden Cup matches have priority over the League matches and are counted as due to be
...
two teams involved.</p>
<p>Other competitions</p>
<ol>
<li>In a group or round robin competition, all members of the group shall compete against each other
...
determined by lot. This does not apply to Fred Holden Cup matches</li>
</ol>
      </div>
      </div>
    </FrontLayout>
