    ...
    <FrontLayout maxWidth>
      <div className='max-w-[768px] mx-auto'>
        ...
        <div className='text-sm'>
          ...
          <ol>
            <li className='my-4'>2. The League shall be open to participation by clubs, teams and individuals in the East Lancashire
              district subject to the approval of the Committee.
            </li>
          </ol>
          <p className='my-4'>2a. The League shall be non- profit making and any surplus shall be ploughed back into the League
            and shall not be for the financial gain of any individual.
          </p>
          <p className='my-4'>2b. The principal purposes and functions of the League shall be to promote and support table tennis
          ...
          <ol>
            <li className='my-4'>3. The League shall be affiliated to the English Table Tennis Association (“Table Tennis England” /
              “TTE”) and the Lancashire County Table Tennis Association (“LCTTA”) and shall comply with their
              rules and regulations.
            </li>
          </ol>
          <p className='my-4'>3a. Only TTE registered Compete and Compete Plus Members may play in the leagues, competitions
          ...
          <ol className='list-disc pl-12 my-4'>
            <li>All persons who register to play in the League during the season (which shall commence immediately <span className='hljs-keyword'>after</span> <span className='hljs-keyword'>the</span> Annual General Meeting (“AGM”) held <span className='hljs-keyword'>in</span> May each <span className='hljs-built_in'>year</span> <span className='hljs-keyword'>and</span> <span className='hljs-keyword'>end</span> <span className='hljs-keyword'>with</span>
            ...
            <li>Any former player members of the League or other persons who (in either case) are accepted by the Committee <span className='hljs-keyword'>as</span> Non-playing Members.</li>
          </ol>
          <p className='my-4'>4a. All applications for playing membership of the League shall be made in accordance with the Rules
            below only to the Fixtures Secretary, who shall decide upon the application unless overridden by the
            Committee.
          </p>
          <p className='my-4'>4b. All Fees shall be paid prior to the commencement (normally in September) of the Annual League
            Programme or immediately upon joining during the Programme in accordance with the Rules below
            and will include: TTE and LTTA registration, individual membership, team fees, and, for those playing out of Hyndburn Table Tennis Centre, room and table fees. Fees (other than TTE/ LCTTA registration
          ...
          <p className='my-4'>4c. All clubs, teams and individuals joining the League shall be deemed to accept this Constitution
            and Rules on admission.
          </p>
          <p className='my-4 font-bold'>The General Committee</p>
          <ol>
            <li className='my-4'>5. The Committee shall consist of the Officers and other Committee Members elected at the AGM or
          ...
          <p className='my-4'>5b. All such Officers and Committee Members shall hold office for two Seasons from the AGM at
          ...
          <p className='my-4'>5d. The Committee shall meet as and when decided at their last meeting or when called by the
          ...
          <ol>
            <li className='my-4'>6. All meetings of the League and of the Committee shall be chaired by the Chairman or, in his
          ...
          <p className='my-4'>6a. AGM: The Annual General Meeting of the League shall be held during May each year on a date to
          ...
          <p className='my-4'>6c. EGM: An Extraordinary General Meeting (“EGM”) of the League to resolve any significant issues
          ...
          <ol>
            <li className='my-4'>7. No election of Officers or alteration to this Constitution and Rules may be made except at the AGM
          ...
          <ol>
            <li className='my-4'>8. The League may only be dissolved by successful motion at an AGM or EGM. Advance Notice of
          ...
          <p className='my-4'>8a. In the event that the League is dissolved or otherwise wound up, any surplus assets (including
          ...
          <ol>
            <li className='my-4'>9. The annual league competition will normally begin in September and will be a competition for
          ...
          <p className='my-4'>10. In the event that a situation arises that is not covered by the Rules, or a rule is unclear, or in other
          ...
          <ol>
            <li className='my-4'>11. All players wishing to play in the annual league must be registered in a team of at least three.
            ...
            <li className='my-4'>12. All Team Secretaries must provide a telephone number where they can be contacted and an
            ...
            <li className='my-4'>13. Any change of Team Secretary, Venue, Match night, address or telephone number shall be
              notified immediately to the Fixtures Secretary. In addition the opposition Team Secretaries shall be
              notified as soon as possible
            </li>
            <li className='my-4'>14. Teams from all divisions can have a team of up to eight players registered at any one time,
              however teams from within the lowest division may have up to 10 players registered at any one time.
            </li>
            <li className='my-4'>15. Each team shall register sufficient players to enable it to fulfil the entire League season and cup
              matches programme.
            </li>
          </ol>
          <p className='my-4'>16. Fees (per season) &amp; entry to the league: All Team Secretaries shall forward to the Fixtures
          ...
          <p className='my-4'>17. Each division is based normally on having ten teams, each team will play home and away. At the
          ...
          <ol>
            <li className='my-4'>18. All players must be registered with both TTE and the League and have paid their membership
            ...
            <li className='my-4'>19. During the season any transfers to another team are to be made in writing to the League
          ...
          <p className='my-4'>19a. Any player having a handicap of 6 or less must play at least 25% of the remaining league
            matches otherwise any points won will be discounted. Playing in a doubles game does not qualify as
            a match.
          </p>
          <ol>
            <li className='my-4'>20. Any team can nominate reserves providing they are from a lower division or the same division and
              ...
              required (“the ranking provision”- if in doubt ring to check eligibility of reserve with the Fixtures Secretary
              before playing). A reserve can play for more than one team per division but if he/she plays for the same
              team <span className='font-bold'>more than 5 times</span> will automatically be transferred permanently to that team and can no longer
          ...
          <p className='my-4'>20a. Provided that the above ranking provision is complied with, Junior players can play up for any team
            in any division any number of times.
          </p>
          <p className='my-4'>20b. A team consisting wholly of Junior players may play all their fixtures at their home venue. In the
            event that both teams are all Juniors the normal home and away system will apply
          </p>
          <p className='my-4'>20c. A team consisting wholly of Junior players may play all their fixtures at their home venue. In the
          ...
          <p className='my-4'>21. If a team resigns from the League, all points will be removed and all monies forfeited.
          </p>
          <ol>
            <li className='my-4'>22. To be included in the final Merit Table a player must play a minimum of 50% +1 of possible league
              matches during the season.
            </li>
          </ol>
          <p className='my-4 font-bold'>Matches and Points</p>
          <ol>
            <li className='my-4'>23. The current rules of table tennis as adopted by TTE and LCTTA shall apply to all matches in the
              League
            </li>
            <li className='my-4'>24. All matches shall ideally be played on the dates stated on the fixture list. If either team is unable to
          ...
          <p className='my-4'>24a. A match can be postponed without penalty if more than 2 weeks notice is given to the other
            team. The opposition Team Secretary must agree to re-arrange the match.
          </p>
          <p className='my-4'>24b. A match can be postponed without penalty if a team cannot field three players due to a town
            team commitment. The opposition Team Secretary must agree to re-arrange the match.
          </p>
          <p className='my-4'>24c. No re-arrangements may be made or requested on the same days as the original fixture date,
            save in exceptional circumstances such as inclement weather.
          </p>
          <ol>
            <li className='my-4'>25. Any points won by an unregistered (See Notes on Affiliation and Membership) player(s) will not be
              counted nor awarded retrospectively. The opposition will be awarded the points as if that player(s)
              had not been present.
            </li>
            <li className='my-4'>26. The start time for matches shall be no later than 7.00pm at HTTC and at St Peters Burnley, 7.30pm at
            ...
            <li className='my-4'>27. The Home team shall enter the playing order of its players on the scorecard first, then the away
            ...
            <li className='my-4'>28. The match ball must be approved by both teams prior to the commencement of the match. In the
              event that an agreement cannot be reached a new ball must be used.
            </li>
            <li className='my-4'>29. The Home team’s Team Secretary has the sole responsibility to notify the Fixtures Secretary of
            ...
            <li className='my-4'>30. In the event of two or more teams having the same number of points at the end of the season,
          ...
          <ol>
            <li className='my-4'>31. Players from anywhere in the League can be signed on for a team in a cup match, but they can
              only play for one team in a season
            </li>
          </ol>
          <ol>
            <li className='my-4'>32. No player shall be eligible to take part in the ELTTL Closed Competition (the Big Day) unless they
          ...
          <p className='my-4'>33. The Fred Holden Competition will be organised during the season. This will be organised on a
            team handicap basis. All teams will participate.
          </p>
          <p className='my-4'>33a. Fred Holden Cup matches have priority over the League matches and are counted as due to be
          ...
          <ol>
            <li className='my-4'>34. In a group or round robin competition, all members of the group shall compete against each other
