...
export default async function Page({params}) {
  ...
  const response = await axios.get(`${apiUrl}/fixture`, {
    params: {
      year: year,
      teamLeftSlug: teamLeftSlug,
      teamRightSlug: teamRightSlug,
    }
  });
  ...
  return (
    <FrontLayout>
      ...
      <p>Home team venue <Link href={`/venue/${year}/${data.venue.slug}`}>{data.venue.name}</Link></p>
      <div>
